...
const (
	...
	LabelMachineIPV4 PlatformLabel = "pml.io/machine-ip"
	// LabelMachineIPV6Head specifies the lable in node.
	LabelMachineIPV6Head PlatformLabel = "pml.io/machine-ipv6-head"
	// LabelMachineIPV6Tail specifies the lable in node.
	LabelMachineIPV6Tail PlatformLabel = "pml.io/machine-ipv6-tail"
)
