	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1alpha1().Machines().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1alpha1().Machines().Watch(context.TODO(), options)
			},
		},
		&platformv1alpha1.Machine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1alpha1.Machine{}, f.defaultInformer)
}
