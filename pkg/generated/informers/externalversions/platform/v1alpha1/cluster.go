...
import (
	...
	platformv1alpha1 "pml.io/april/pkg/apis/platform/v1alpha1"
	versioned "pml.io/april/pkg/generated/clientset/versioned"
	internalinterfaces "pml.io/april/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "pml.io/april/pkg/generated/listers/platform/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PlatformV1alpha1().Clusters().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PlatformV1alpha1().Clusters().Watch(context.TODO(), options)
			},
		},
		&platformv1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&platformv1alpha1.Cluster{}, f.defaultInformer)
}
