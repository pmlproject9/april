...
import (
	...
	kubeletv1beta1 "pml.io/april/pkg/platform/provider/baremetal/apis/kubelet/config/v1beta1"
	kubeproxyv1alpha1 "pml.io/april/pkg/platform/provider/baremetal/apis/kubeproxy/config/v1alpha1"
)
